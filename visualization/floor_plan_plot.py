...
class FloorplanPlot:
    ...
    def draw_polygons(self, polygons: List[Polygon], color='b', linewidth=1, linestyle="-", alpha=None, **kwargs):
        if self.axis is None:
            self.init_plot()
        ...
        for idx, polygon in enumerate(polygons):
            ...
            self.axis.plot(x, y, color=pal[idx], linewidth=linewidth, linestyle=linestyle, alpha=alpha, **kwargs)
